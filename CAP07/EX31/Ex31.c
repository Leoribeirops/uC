void main() {
    ...
    while (1) {  // Loop infinito para manter a sequência rodando enquanto o circuito estiver energizado
        while ((portb.rb0 == 0) && (portb.rb1 == 0)) {  // Enquanto ambas as chaves estiverem pressionadas
            portd.rd0 = 1;  // Liga o LED 0
        }
        portd.rd0 = 0;  // Desliga o LED 0 quando uma ou ambas as chaves forem liberadas
    }
}
